...
public class SurvivalPropsRuleScene extends Scene implements CommandSolver.MouseCommandListener {
    ...
    public void sceneBegin() {
        ...
        //next
        labels.add(new game.Menu.Label(100,80,"NEXT",FontLoader.Blocks(50)));
        buttons.add(new Button(labels.get(9).collider().left()-10,labels.get(9).collider().bottom()-50,160,60,new Animation(AllImages.inputButton)));
